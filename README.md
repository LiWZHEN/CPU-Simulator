...
* 传输
      ...
      -> RoB: 指令类型、要写回的寄存器编号、操作值
              （如果操作值是立即数，应告知is_ready为true）
...
### RoB
#### 连接元件
* 时序：RS, LSB, Decoder, RF, PC, Predictor
#### 运行操作
* 检查分支预测错误信号
